...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint, debug_from,
    ...
    if args.opacity_decay and args.opacity_decay_mode == "mlp":
        ...
        if args.pretrain:
            pretrain_coefficient(coefficient, args.opacity_decay_mode, args.f_min, args.p, args.f_max)
    else:
        coefficient = None
        
    gaussians = GaussianModel(dataset.sh_degree, gaussian_dim=gaussian_dim, time_duration=time_duration, rot_4d=rot_4d, force_sh_3d=force_sh_3d, sh_degree_t=2 if pipe.eval_shfs_4d else 0, coefficient=coefficient)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--f_max', default=1.0, type=float, help='max factor')
